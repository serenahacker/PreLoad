...
posthoc_path = f'./posthoc_models/{args.ood_data}'
posthoc_model_suffix = f'_{args.randseed}'
...
model_suffix = f'_preload_ft_{args.randseed}'
...
model.network_part1.load_state_dict(torch.load(f'{pretrained_path}/{args.dataset}{plain_model_suffix}.pt'))
model.network_part2.load_state_dict(torch.load(f'{posthoc_path}/{args.dataset}{posthoc_model_suffix}.pt'))

# read sweep params from json file
sweep_params_file = f'hyperparameter_sweeps/preload_ft_best_hyperparams.json'
